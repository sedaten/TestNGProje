...
public class webTabletTest extends TestBase {
    ...
    public void table() {
        ...
        List<WebElement> basliklar = driver.findElements(By.xpath("//thead/tr/th"));//tablodaki basliklar icin
    ...
    public void tumSatirlar() {
        ...
        List<WebElement> tumSatirlar = driver.findElements(By.xpath("//tbody/tr"));//Tablodaki tum satirlar
    ...
    public void tumHucreler() {
        ...
        List<WebElement> tumHucreler = driver.findElements(By.xpath("//tbody/tr/td"));//tablodaki tum hucreler
        for (WebElement hucre : tumHucreler) {
            System.out.println(hucre.getText());
            //tbody/tr[4]/td[5] (4 satir 5inci hucre
        }
    }
